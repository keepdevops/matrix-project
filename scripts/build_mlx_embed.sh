...
for BIN in "$BUILD_DIR/mlx_embed_probe" "$BUILD_DIR/mlx_generate_probe" "$BUILD_DIR/mlx_bench_probe" "$BUILD_DIR/mlx_registry_probe" "$BUILD_DIR/mlx_concurrency_probe"; do
  if [[ -f "$BIN" ]]; then
