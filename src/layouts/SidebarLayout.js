...
import SidebarLayoutAside from './SidebarLayoutAside';
    ...
    <div className="sl-root">
      ...
      <div className={`sl-body${sidebarCollapsed ? ' sl-body--collapsed' : ''}`}>
        <SidebarLayoutAside
          ...
          showHistory={showHistory} history={history} lastMeta={lastMeta}
          onDeployed={onDeployed} onHistorySelect={onHistorySelect}
        />
