...
export default function DashboardMainGrid({
  online, activeAgents, activeMode, responses, finalAnswer, loading, history,
  lastMeta, currentSession, backend, switchBackend, useRag, pendingPrompt,
  flatPickAgent, stageOutputs, selectedPrompt, selectedTemperature,
